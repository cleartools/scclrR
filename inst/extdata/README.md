...
- `angelidis_lung_pseudobulk_counts.mtx.gz`: genes by mouse samples sparse count
  matrix.
- `angelidis_lung_pseudobulk_samples.csv`: sample metadata, including age labels.
- `angelidis_lung_pseudobulk_genes.csv`: gene identifiers.
